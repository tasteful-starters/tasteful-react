...
- Create a basic ToDo List Stateful Component `src/todo-app/todo-app.component.js`
...
- Setup babel to allow for arrow functions in Class functions

    ```bash
    npm install --save-dev @babel/preset-react @babel/plugin-proposal-class-properties
    ```

    Create a `.babelrc` in the root with:
    ```javascript
    {
